...
# | ██ | Tags: None                                                                        | ██ |
# +----+-----------------------------------------------------------------------------------+----+
# | ██ | Meta: https://docs.discord.com/developers/resources/guild#add-guild-member-role   | ██ |
# +----+-----------------------------------------------------------------------------------+----+
discord_add_guild_member_role:
  ...
  script:
    ...
    - definemap request_headers:
        ...
        X-Audit-Log-Reason: Automated member role addition via Denizen script

    - ~webget <[url_endpoint]> headers:<[request_headers]> method:PUT
